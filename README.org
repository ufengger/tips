...
描述见 [[https://kojipkgs.fedoraproject.org//packages/freetype/2.13.0/1.fc39/x86_64/freetype-2.13.0-1.fc39.x86_64.rpm
]]
解决办法：

1. 下载低版本的 ~libfreetype~ ([[https://kojipkgs.fedoraproject.org//packages/freetype/2.13.0/1.fc39/x86_64/freetype-2.13.0-1.fc39.x86_64.rpm
]])
2. 解压后，将 ~libfreetype.so.6.19.0~ 复制到 ~/opt/kingsoft/wps-office/office6/~
